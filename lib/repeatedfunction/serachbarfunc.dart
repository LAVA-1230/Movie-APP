...
class _SerachbarfuncState extends State<Serachbarfunc> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Padding(padding: const EdgeInsets.only(left: 10.0, top: 30, bottom: 20, right: 10),
                ...
                child: TextField( autofocus: false,
                                  ...
                                  onSubmitted: (value){searchresult.clear();
                                                      setState(() {
                                                        val1 = value;
                      FocusManager.instance.primaryFocus?.unfocus();
                                                      });},
                ...
                decoration: InputDecoration(suffixIcon: IconButton(onPressed: (){Fluttertoast.showToast(
                              webBgColor: "#000000",
                              webPosition: "center",
                              webShowClose: true,
                              msg: "Search Cleared",
                          ...
                          ? FutureBuilder(future: searchlistfunction(val1), 
                                          builder: (context,snapshot){
                                            if(snapshot.connectionState==ConnectionState.done){
                                              return Container(height: 400 ,
                                                              child: ListView.builder(itemCount: searchresult.length,
                                                    ...
                                                    decoration: BoxDecoration(borderRadius:
                                                        BorderRadius.all(
                                                            ...
                                                            Padding(padding: const EdgeInsets.all(8.0),
                                                                    child: Container(child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                                                  children: [Container(
                                                          alignment: Alignment
                                                              .topCenter,
                                                          child: Text(
                                                        ...
                                                        Container(child: Row(children: [Container(padding:
                                                                    EdgeInsets
                                                                        .all(5),
                                                                height: 30,
                                                                decoration: BoxDecoration(
                                                                  ...
                                                                  child: Center(child: Row(mainAxisAlignment: MainAxisAlignment.center,
                                                                                          children: [Icon(Icons.star,color: Colors.amber,size: 20,),
                                                                                          SizedBox(width: 5,),
                                                          ...
                                                          Container( padding:
                                                                ...
                                                                0.4,
                                                            height: 85,
                                                            child: Text(textAlign: TextAlign.left,' ${searchresult[index]['overview']}',style: TextStyle(fontSize: 12,color: Colors.white),),)],),),)
                                              ],),),);
                                  },),);
                                            }
                                            else{return Center(
